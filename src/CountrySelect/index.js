...
export default function CountrySelect() {
	return (
		<Autocomplete
			options={countries}
			defaultValue={countries.find(c => c.code === "IN")}
			autoHighlight
			...
			renderOption={(props, option) => (
				<Box component="li" sx={{ '& > img': { mr: 2, flexShrink: 0 } }} {...props}>
					<img
						loading="lazy"
						width="20"
						src={`https://flagcdn.com/32x24/${option.code.toLowerCase()}.png`}
						srcSet={`https://flagcdn.com/64x48/${option.code.toLowerCase()}.png 2x`}
						alt={option.label}
					/>
